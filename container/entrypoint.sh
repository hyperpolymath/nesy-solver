...
# Nesy Solver container entrypoint
#
...
cleanup() {
    echo "Received shutdown signal — stopping nesy-solver..."
...
# Examples:
#   exec /app/nesy-solver
#   exec /app/release/bin/nesy-solver start
#   exec /app/nesy-solver serve --host "${APP_HOST}" --port "${APP_PORT}"
