...
;;
;; Guix package definition for Nesy Solver
;;
;; Usage:
;;   guix shell -D -f guix.scm    # Enter development shell
;;   guix build -f guix.scm       # Build package
;;
;; TODO: Replace Nesy Solver and customize inputs for your language/stack.
...
(package
  ...
  (home-page "https://github.com/hyperpolymath/Nesy Solver")
  (synopsis "Live proof playground for neurosymbolic theorem provers — backed by a learning loop across hypatia/echidna/verisimdb")
