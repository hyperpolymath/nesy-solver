...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/nesy-solver/security/advisories/new)
...
- This repository (`hyperpolymath/nesy-solver`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/nesy-solver/security/advisories)
...
When using Nesy Solver, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/nesy-solver/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/nesy-solver/security/advisories/new) or j.d.a.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/nesy-solver/discussions) |
...
*Thank you for helping keep Nesy Solver and its users safe.* 🛡️
