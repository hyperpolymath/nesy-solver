...
// Replace nesy-solver, deno task build, deno test, ReScript, Deno, zig, Idris2, Zig with actuals
...
Idris2 ABI + Zig FFI; MPL-2.0; no TypeScript; Deno not Node
